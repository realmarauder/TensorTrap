...
class ContextAnalyzer:
    ...
    def _validate_zip_structure(self, data: bytes) -> Dict[str, Any]:
        ...
        """
        result = {"is_valid": False, "reason": "", "details": {}}
    ...
    def _check_executable_context(
        ...
        for pattern in self.EXECUTABLE_PATTERNS:
            if pattern.search(chunk):
                ...
                pattern_str = pattern.pattern.decode() if isinstance(pattern.pattern, bytes) else pattern.pattern
